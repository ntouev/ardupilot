/*
 ...
 !!!!
 Edited file - Replace the auto-generated file with this, after ./waf configure. 
               The first build will overwrite it. The next not. 
 !!!!
*/
...
#define CHIBIOS_BOARD_NAME "MatekH743-bdshot"
...
// SPI device table
#define HAL_SPI_DEVICE0  SPIDesc("icm42688"       ,  0,  1, PAL_LINE(GPIOC,15U), SPIDEV_MODE3,   1*MHZ,  16*MHZ)
...
#define HAL_SPI_DEVICE3  SPIDesc("icm42605"       ,  3,  1, PAL_LINE(GPIOC,13U), SPIDEV_MODE3,   1*MHZ,  16*MHZ)
...
{  4,  2*3.30/4096 }, /* PC4 PRESSURE_SENS */ \
{  7,    3.30/4096 }, /* PA7 BATT2_CURRENT_SENS */ \
{  8,    3.30/4096 }, /* PC5 RSSI_ADC */ \
{ 10,    3.30/4096 }, /* PC0 BATT_VOLTAGE_SENS */ \
{ 11,    3.30/4096 }, /* PC1 BATT_CURRENT_SENS */ \
{ 18,    3.30/4096 }, /* PA4 BATT2_VOLTAGE_SENS */ \
}
...
#define STM32_SPI_SPI2_RX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
...
#define STM32_SPI_SPI3_RX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
#define STM32_SPI_SPI3_RX_DMA_CHAN     STM32_DMAMUX1_SPI3_RX
#define STM32_SPI_SPI3_TX_DMA_STREAM   STM32_DMA_STREAM_ID(2, 5) // shared SPI3_TX, USART3_TX
...
#define STM32_TIM_TIM1_UP_DMA_STREAM   STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
...
#define STM32_UART_UART7_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
...
#define STM32_UART_USART1_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
...
#define STM32_UART_USART2_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
...
#define STM32_UART_USART3_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 5) // shared SPI3_TX, USART3_TX
#define STM32_UART_USART3_TX_DMA_CHAN  STM32_DMAMUX1_USART3_TX
#define STM32_UART_USART6_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 7) // shared SPI2_RX,SPI3_RX,USART1_TX,USART2_TX,USART3_TX,UART7_TX,TIM1_UP,USART6_TX
...
#define HAL_UARTI_DRIVER ChibiOS::UARTDriver uartIDriver(8)
#define HAL_UARTJ_DRIVER Empty::UARTDriver uartJDriver
#define HAL_WITH_IO_MCU 0

#define HAL_CRASH_SERIAL_PORT UART7
#define IRQ_DISABLE_HAL_CRASH_SERIAL_PORT() nvicDisableVector(STM32_UART7_NUMBER)
#define RCC_RESET_HAL_CRASH_SERIAL_PORT() rccResetUART7(); rccEnableUART7(true)
#define HAL_CRASH_SERIAL_PORT_CLOCK STM32_UART7CLK
...
#endif
#define HAL_SERIAL8_PROTOCOL HAL_OTG2_PROTOCOL
#define HAL_SERIAL8_BAUD 115200
#endif
#define HAL_UART_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART2_CONFIG,HAL_UART7_CONFIG,HAL_USART1_CONFIG,HAL_USART3_CONFIG,HAL_UART8_CONFIG,HAL_UART4_CONFIG,HAL_USART6_CONFIG,HAL_OTG2_CONFIG
